        ...
        *,
        ...
        try:
            if action == "click":
                ...
                if value is None:
                    raise ValueError("'fill' aksiyonu için 'value' gerekli.")
                await page.fill(selector, value, timeout=timeout_ms)
                success = True
            elif action == "select":
                if value is None:
                    raise ValueError("'select' aksiyonu için 'value' gerekli.")
                ...
                if value is None:
                    raise ValueError("'press' aksiyonu için 'value' (tus adi) gerekli.")
