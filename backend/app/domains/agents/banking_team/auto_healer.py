...
class AutoHealerAgent(BaseAgent):
    ...
    def _get_live_dom(self, page_url: str, session_id: str = "") -> str:
        ...
        try:
            ...
            try:
                loop = asyncio.get_running_loop()
                # Zaten async context'teyiz — yeni thread'de çalıştır
    ...
    def heal_with_live_dom(self, test_info: dict, session_id: str = "") -> dict:
        ...
        Akis:
          ...
          3. Healed selector gerçek browser'da dogrulanir
          4. Sonuç screenshot_before / screenshot_after ile zenginlestirilir
        """
        broken_selector = test_info.get("selector", "")
        ...
        # 3. Healed selector'i gerçek browser'da dogrula
