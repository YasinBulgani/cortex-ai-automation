...
SEED_SCENARIOS: list[SeedScenario] = [
    ...
    SeedScenario(
        ...
        prompt=(
            "Para transferi ekranına git, "
            "alıcı listesinden ilk kişiyi seç, "
            "tutar alanına '250' yaz, "
            "açıklama alanına 'Test transferi' yaz, "
            "'Transfer Yap' butonuna bas, "
            "onay ekranında tutarın '250' göründüğünü doğrula, "
            "'Onayla' butonuna bas, "
            "'Transfer başarılı' mesajının göründüğünü doğrula."
        ),
        expected_steps=12,
    ...
    SeedScenario(
        ...
        prompt=(
            "Uygulamayı aç, "
            "kayıt formuna git, "
            "tüm alanları boş bırak, "
            "'Kayıt Ol' butonuna bas, "
            "'Bu alan zorunludur' hata mesajının göründüğünü doğrula, "
            "email alanına geçersiz format 'testtest' yaz, "
            "'Geçerli bir e-posta girin' hata mesajının göründüğünü doğrula."
        ),
        expected_steps=8,
    ...
    SeedScenario(
        ...
        prompt=(
            "Uygulamayı aç, "
            "ana menüde 'Kampanyalar' sekmesine dokun, "
            "kampanya listesinin yüklendiğini doğrula, "
            "ilk kampanyaya dokun, "
            "kampanya detay sayfasının açıldığını doğrula, "
            "geri dön, "
            "ana menü ekranında olduğunu doğrula."
        ),
        expected_steps=9,
        tags=["navigation", "P3"],
    ),
    SeedScenario(
        ...
        prompt=(
            "Uygulamayı aç, "
            "medya kütüphanesi ekranına git, "
            "ilk videoya dokun, "
            "video oynatıcının başladığını doğrula, "
            "duraklat butonuna bas, "
            "videonun duraklatıldığını doğrula, "
            "ileri sar butonuna bas, "
            "ses kısma butonuna bas, "
            "ses simgesinin 'sessiz' moduna geçtiğini doğrula."
        ),
        expected_steps=11,
    ...
    SeedScenario(
        ...
        prompt=(
            "Uygulamayı aç, "
            "profil veya ayarlar sayfasına git, "
            "'Görünüm' veya 'Tema' seçeneğine dokun, "
            "'Koyu Tema' seçeneğini seç, "
            "arka planın koyu renge döndüğünü doğrula, "
            "'Açık Tema' seçeneğine geri dön, "
            "arka planın açık renge döndüğünü doğrula."
        ),
        expected_steps=9,
    ...
    SeedScenario(
        ...
        prompt=(
            "Uygulamayı aç, "
            "ana sayfadaki tüm butonların content-desc etiketine sahip olduğunu doğrula, "
            "giriş formu ekranına git, "
            "email alanının 'Email adresi' etiketine sahip olduğunu doğrula, "
            "şifre alanının 'Şifre' etiketine sahip olduğunu doğrula, "
            "giriş butonunun 'Giriş yap' content-desc değerine sahip olduğunu doğrula."
        ),
        expected_steps=10,
