...
def upgrade() -> None:
    ...
    if "test_management_projects" not in existing:
        op.create_table(
    ...
    op.create_index("ix_test_management_projects_tenant_id", "test_management_projects", ["tenant_id"], if_not_exists=True)
    op.create_index("ix_test_management_projects_tspm_project_id", "test_management_projects", ["tspm_project_id"], if_not_exists=True)

    if "test_management_suites" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_suites_project_id", "test_management_suites", ["project_id"], if_not_exists=True)

    if "test_management_folders" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_folders_suite_id", "test_management_folders", ["suite_id"], if_not_exists=True)

    if "test_management_cases" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_cases_project_id", "test_management_cases", ["project_id"], if_not_exists=True)
    op.create_index("ix_tm_cases_suite_id", "test_management_cases", ["suite_id"], if_not_exists=True)
    op.create_index("ix_tm_cases_folder_id", "test_management_cases", ["folder_id"], if_not_exists=True)

    if "test_management_case_steps" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_case_steps_case_id", "test_management_case_steps", ["case_id"], if_not_exists=True)

    if "test_management_case_versions" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_case_versions_case_id", "test_management_case_versions", ["case_id"], if_not_exists=True)

    if "test_management_plans" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_plans_project_id", "test_management_plans", ["project_id"], if_not_exists=True)

    if "test_management_cycles" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_cycles_plan_id", "test_management_cycles", ["plan_id"], if_not_exists=True)

    if "test_management_runs" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_runs_cycle_id", "test_management_runs", ["cycle_id"], if_not_exists=True)

    if "test_management_run_cases" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_run_cases_run_id", "test_management_run_cases", ["run_id"], if_not_exists=True)
    op.create_index("ix_tm_run_cases_case_id", "test_management_run_cases", ["case_id"], if_not_exists=True)

    if "test_management_run_step_results" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_run_step_results_run_case_id", "test_management_run_step_results", ["run_case_id"], if_not_exists=True)

    if "test_management_execution_evidence" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_execution_evidence_run_case_id", "test_management_execution_evidence", ["run_case_id"], if_not_exists=True)

    if "test_management_requirement_links" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_requirement_links_project_id", "test_management_requirement_links", ["project_id"], if_not_exists=True)
    op.create_index("ix_tm_requirement_links_case_id", "test_management_requirement_links", ["case_id"], if_not_exists=True)

    if "test_management_defect_links" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_defect_links_run_case_id", "test_management_defect_links", ["run_case_id"], if_not_exists=True)

    if "test_management_import_jobs" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_import_jobs_project_id", "test_management_import_jobs", ["project_id"], if_not_exists=True)

    if "test_management_import_job_rows" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_import_job_rows_job_id", "test_management_import_job_rows", ["job_id"], if_not_exists=True)

    if "test_management_audit_events" not in existing:
        op.create_table(
    ...
    op.create_index("ix_tm_audit_events_project_id", "test_management_audit_events", ["project_id"], if_not_exists=True)
