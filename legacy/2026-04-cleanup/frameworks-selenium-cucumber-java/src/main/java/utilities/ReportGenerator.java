...
public class ReportGenerator {
    ...
    public static void generateMasterthoughtReport() {
        ...
        Configuration configuration = new Configuration(reportOutputDir, ConfigReader.getProjectName());
        ...
        try {
            ...
            if (domainToJsonPath.isEmpty()) {
                ...
                if (new File(legacy).exists()) {
                    String domain = domains.isEmpty() ? ConfigReader.getDefaultDomain() : domains.get(0);
