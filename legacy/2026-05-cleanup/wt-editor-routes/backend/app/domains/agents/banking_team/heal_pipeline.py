...
Akis:
  ...
  2. AutoHealer kirik selector'lari tamir onerir
  3. Playwright MCP ile onerilen selector gercek browser'da dogrulanir
...
class HealPipeline:
    ...
    async def run(
        ...
        """Kirik testleri tamir et, dogrula ve dosyalari guncelle.

        Args:
            failed_tests: Kirik test bilgileri listesi.
    ...
    def _update_test_file(
        ...
        """Test dosyasinda eski selector'i yenisiyle degistir.
        ...
        try:
            ...
            if old_selector not in content:
                # Olasi farklilik: tirnak turu degismis olabilir
