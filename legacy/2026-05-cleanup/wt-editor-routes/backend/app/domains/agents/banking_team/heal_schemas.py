...
class HealTestEntry(BaseModel):
    """Tek bir kirik test bilgisi."""
    file: str = Field(default="", description="Test dosya yolu")
    test_name: str = Field(default="", description="Test adi")
    selector: str = Field(default="", description="Kirik selector")
    error: str = Field(default="", description="Hata mesaji")
...
class HealResponse(BaseModel):
    """Heal pipeline sonuc ozeti."""
    total_broken: int = Field(default=0, description="Toplam kirik test sayisi")
...
class HealStatsResponse(BaseModel):
    ...
    success_rate: float = Field(default=0.0, description="Basari orani (0-1)")
