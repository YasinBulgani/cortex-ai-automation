...
class ApiEnvironment(Base):
    ...
    # Hassas degiskenler maskelenir (sifre, token, api_key)
...
class ApiTestCase(Base):
    """
    AI tarafindan uretilen veya kullanici tarafindan olusturulan
    tek bir API test case'i.

    test_type degerleri:
      positive    — Gecerli parametrelerle basarili cagri
      negative    — Gecersiz/eksik parametre, yetkisiz erisim
    ...
    # Son calisma durumu (denormalized for quick access)
...
class ApiChain(Base):
    ...
    Her adim arasinda veri eslestirmesi (JSON Path) tanimlanir.
    ...
    # Variable extractions (tum chain boyunca)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 6. API EXECUTION DETAIL — Istek bazinda calisma detayi
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class ApiExecutionDetail(Base):
    ...
    Her calisma (run) birden fazla execution detail icerir.
    ...
    # deepdiff sonucu — onceki basarili calismayla karsilastirma

    # Extracted variables (chain icin)
...
class HealingLog(Base):
    ...
    Her basarisiz test icin siniflandirma, strateji ve
