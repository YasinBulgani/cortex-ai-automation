      ...
      {uploads.length > 0 && (
        ...
        >
          {uploads.map(row => {
            ...
            return (
              <div key={row.id} className="flex items-center justify-between px-4 py-3 border-b border-slate-800 last:border-0 hover:bg-slate-800/30" data-testid={`import-row-${row.id}`}>
