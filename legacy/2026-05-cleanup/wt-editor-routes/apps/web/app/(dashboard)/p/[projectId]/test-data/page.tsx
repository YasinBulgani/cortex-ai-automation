...
export default function TestDataPage() {
  ...
  const load = useCallback(() => {
    apiFetch<DataSet[]>(basePath).then(setDataSets).catch(() => {});
  }, [basePath]);
  ...
  const inputCls =
    "rounded-xl border border-slate-700 bg-slate-900 px-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50";
