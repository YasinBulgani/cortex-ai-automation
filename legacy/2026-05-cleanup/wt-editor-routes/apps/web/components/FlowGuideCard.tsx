...
const STAGE_CONFIG: Record<FlowStageId, FlowStageConfig> = {
  discover: {
    flowKey: "Kesfet",
    label: "Kesfet",
    summary: "Bu asamada proje baglamini toplar, dokumanlari yukler ve gereksinim tabanini netlestirirsiniz.",
    checklist: [
      "Dosya veya kaynaklari iceri alin.",
      "Gereksinim ve kapsam bosluklarini gozden gecirin.",
      "Sonraki tasarim asamasi icin temiz baglam olusturun.",
    ],
    ...
    productNotes: {
      ...
      service: "Servis testleri icin spec ve dokuman baglami burada netlesir.",
      data: "Veri odaginda import edilen baglam sentetik veri ihtiyacini dogru kurar.",
      intelligence: "AI kalite katmani icin kaynak ve grounding temeli burada olusur.",
    },
  ...
  design: {
    ...
    checklist: [
      ...
      "AI test case sonucunu gozden gecirin.",
    ...
    productNotes: {
      ...
      studio: "Studio icin bu ekran ana deger alanidir; senaryo ve onay kalitesi burada sekillenir.",
      web: "Web otomasyonunun dogru artefakta donusmesi icin kaynak senaryolar burada temizlenir.",
      intelligence: "AI onerilerinin dogru geri beslenmesi icin tasarim kalitesi kritiktir.",
    },
    previous: { label: "Kesfet'e Don", path: "import" },
  ...
  data: {
    flowKey: "Veri",
    label: "Veri",
    summary: "Sentetik veri ve fixture setleri burada hazirlanir; otomasyon ve servis kosulari bu veriyle baglanir.",
    checklist: [
      "Gerekli veri setlerini olusturun veya duzenleyin.",
      "Sentetik veri ihtiyacini belirleyin.",
      "Kosularda kullanilacak veri setlerini netlestirin.",
    ],
    priorityProducts: ["data"],
    productNotes: {
      studio: "Tasarim kalitesinin calisabilir olmasi icin veri baglami burada netlesir.",
      ...
      web: "Web kosularinin kirilmamasi icin test verisi burada saglamlastirilir.",
    },
    previous: { label: "Tasarla'ya Don", path: "scenarios" },
    next: { label: "Uret Asamasina Gec", path: "automation-gen" },
    supportLinks: [
  ...
  generate: {
    flowKey: "Uret",
    label: "Uret",
    summary: "Bu asama manuel, dokuman ve AI kaynaklarindan calisan otomasyon artefaktlari uretmek icindir.",
    checklist: [
      "Kaynak senaryolari veya onayli test case'leri secin.",
      "Gerekirse locator ve page object yardimlarini tamamlayin.",
      "Olusan artefakti kosu oncesi gozden gecirin.",
    ],
    priorityProducts: ["web", "mobile"],
    productNotes: {
      studio: "Tasarimda verilen kararlar burada calisan artefakta donusur.",
      web: "Web lensinde bu asama ana uretim hattidir; kod ve locator kalitesi burada belirlenir.",
      mobile: "Mobil odakta bile tekrar kullanilabilir otomasyon artefakti burada sekillenir.",
      intelligence: "AI uretim kalitesi ve artifact kaliciligi burada gorunur hale gelir.",
    },
    previous: { label: "Veri'ye Don", path: "test-data" },
    next: { label: "Calistirmaya Gec", path: "executions" },
    supportLinks: [
      { label: "Dokumandan Otomasyon", path: "manual-to-automation" },
  ...
  execute: {
    flowKey: "Calistir",
    label: "Calistir",
    summary: "UI, servis ve regresyon kosularini burada baslatir, izler ve tekrar calistirirsiniz.",
    checklist: [
      "Uygun kosu tipini secin.",
      "Veri ve artefakt baglaminin hazir oldugunu dogrulayin.",
      "Aktif kosulari ve hata durumlarini takip edin.",
    ],
    priorityProducts: ["one", "service", "web", "mobile"],
    productNotes: {
      one: "Platform cekirdegi icin kosu gorunurlugu ekiplerin ortak ritmini belirler.",
      service: "Servis lensinde assertion ve zincirlerin gercek degeri bu asamada gorulur.",
      web: "Web otomasyonunun uretim kalitesi kosu sonucunda dogrulanir.",
      mobile: "Mobil cihaz matrisi ve paralel run kabiliyeti burada anlam kazanir.",
      intelligence: "AI hata analizi icin taze execution verisi bu asamada toplanir.",
    },
    previous: { label: "Uret'e Don", path: "automation-gen" },
    next: { label: "Raporlara Gec", path: "reports" },
    supportLinks: [
      { label: "API Testleri", path: "api-tests" },
      { label: "Kosu Gecmisi", path: "runs" },
  ...
  observe: {
    ...
    checklist: [
      "Kosu raporlarini ve trendleri karsilastirin.",
    ...
    productNotes: {
      ...
      mobile: "Cihaz bazli kirilimlar ve stream sonuclari burada okunur.",
      intelligence: "AI kalite katmani icin asil karar destegi burada uretilir.",
    },
    previous: { label: "Calistir'a Don", path: "executions" },
    supportLinks: [
...
export function FlowGuideCard({
  ...
  const productNote = config.productNotes[activeProductId] ?? "Bu asama secili urunu destekleyen genel kalite akisinin bir parcasi.";
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {personaFocused && (
              <span className="rounded-full border border-sky-300/20 bg-sky-400/10 px-2.5 py-1 text-[11px] font-medium text-sky-100">
                Bu asama secili personada odakta
              </span>
            )}
          </div>
        ...
        <div className="min-w-[18rem] rounded-xl border border-slate-800 bg-slate-950/45 p-3">
          ...
          <div className="mt-3 rounded-lg border border-slate-800 bg-slate-900/60 px-3 py-2">
            ...
            <p className="mt-1 text-xs leading-5 text-slate-300">
              {productFocused
                ? `${selectedProduct.shortName} icin bu ekran ana akis icinde kritik bir durak.`
                : `${selectedProduct.shortName} icin bu ekran destekleyici; gerekli kadar ilerleyip sonraki asamaya gecebilirsiniz.`}
            </p>
          </div>
        </div>
      </div>
