# Cortex Otomasyon — Installer Üretimi
...
| Launcher | `/Applications/Cortex Otomasyon.app` | `Cortex-Baslat.bat` + Masaüstü kısayolu |
...
6. ~5 dk sonra `/Applications/Cortex Otomasyon.app` hazır
7. Dashboard tarayıcıda açılır

**İlk açılışta "izin verilemedi" uyarısı** alırsanız:
```bash
xattr -d com.apple.quarantine "/Volumes/Cortex Otomasyon 1.0.0/Cortex Setup.command"
```
...
5. Masaüstünde **Cortex Otomasyon** kısayolu
