...
/** POST /api/v1/agents/locator/resolve — Fallback zinciri ile kırık selector çözümleme */
...
/** POST /api/v1/agents/locator/improve — Locator iyilestirme önerileri */
...
/** POST /api/v1/agents/locator/pom/generate — Page Object Model üretimi */
