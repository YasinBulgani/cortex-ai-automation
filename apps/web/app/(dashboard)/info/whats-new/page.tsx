...
const RELEASES: Release[] = [
    ...
    entries: [
      {
        ...
        description: "Neurex Farm artık BROWSERSTACK_USERNAME / SAUCE_USERNAME ayarlandığında testleri gerçek bulut cihazlarında çalıştırıyor. Yerel Playwright emülasyonu otomatik fallback olarak korunuyor.",
        tags: ["Neurex Farm", "Mobile"],
      },
      {
        version: "1.10.0",
        date: "15 Nis",
  ...
  {
    sprint: "Sprint 8 — Neurex Farm Scheduler + Mobil Geçmiş",
    date: "13 Nisan 2026",
    entries: [
      {
        version: "1.8.0",
  ...
  {
    sprint: "Sprint 6 — Neurex Farm (Mobil Test Altyapısı)",
    date: "11 Nisan 2026",
    entries: [
      {
        version: "1.6.0",
        date: "11 Nis",
        badge: "new",
        title: "Neurex Farm — Mobil Cihaz Emülasyonu",
    ...
    <div className="min-h-screen bg-slate-950 p-6 max-w-3xl mx-auto">
      ...
      <div className="mt-12 pt-6 border-t border-slate-800 text-center">
        <p className="text-xs text-slate-600">
          Neurex QA Operations v1.10.0 · Son güncelleme: 15 Nisan 2026
        </p>
      </div>
    </div>
  );
