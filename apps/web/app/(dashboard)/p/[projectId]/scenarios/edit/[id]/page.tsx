  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6" data-testid="scenario-edit-page">
      ...
      <form onSubmit={submit} className="space-y-4" data-testid="scenario-edit-form">
        <div>
          <label htmlFor="scenario-edit-title" className="mb-1 block text-xs text-slate-400">Başlık</label>
          <Input
            id="scenario-edit-title"
            value={title}
        ...
        <div>
          <label htmlFor="scenario-edit-description" className="mb-1 block text-xs text-slate-400">Açıklama</label>
          <textarea
        ...
        <div>
          <label htmlFor="scenario-edit-status" className="mb-1 block text-xs text-slate-400">Durum</label>
          <select
        ...
        <DataBindingCard projectId={projectId ?? ""} dataBindings={dataBindings} onBindingsChange={setDataBindings} />
