#!/usr/bin/env bash
# ============================================================
#  Cortex AI Automation — Mac DMG Builder
# ============================================================
#  Bu script "Cortex AI Automation Setup.dmg" üretir.
...
DMG_NAME="Cortex_Ai_Automation-Setup-${VERSION}-macOS"
...
log "Cortex AI Automation DMG Builder v${VERSION}"
log "Repo:       $REPO_ROOT"
log "Çıktı:      $DMG_PATH"
echo
...
KURULUM:
  ...
  4. Kurulum tamamlandığında "Cortex AI Automation.app" başlatılır.
...
HEDEF DİZİN:
  ~/Applications/Cortex AI Automation/

UYGULAMA:
  /Applications/Cortex AI Automation.app

DEINSTALL:
  rm -rf "~/Applications/Cortex AI Automation"
  rm -rf "/Applications/Cortex AI Automation.app"
...
hdiutil create \
    -volname "Cortex AI Automation ${VERSION}" \
    -srcfolder "$STAGING" \
    -ov \
    -format UDZO \
    -fs HFS+ \
