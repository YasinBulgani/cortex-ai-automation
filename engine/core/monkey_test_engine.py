...
class MonkeyTestEngine:
    ...
    def _check_for_anomalies(self, page) -> List[Dict]:
        ...
        try:
            ...
            logger.debug("JS hata kontrolu basarisiz: %s", exc)
        ...
        for selector in error_selectors:
            try:
                ...
                logger.debug("Hata selector kontrolu basarisiz '%s': %s", selector, exc)
    ...
    def _get_selector(self, element) -> str:
        ...
        try:
            ...
            logger.debug("Selector belirlenemedi: %s", exc)
            return 'unknown'
    ...
    def _is_visible(self, element) -> bool:
        ...
        try:
            ...
            logger.debug("Eleman gorunurlugu kontrol edilemedi: %s", exc)
            return False
