...
@pytest.mark.functional
@pytest.mark.P2
@scenario(FEATURE, "Dosya yükleme alanını görüntüleme")
def test_view_source_selector():
    """Dosya yükleme alanı görünür olmalı."""
...
@pytest.mark.functional
@pytest.mark.P2
@scenario(FEATURE, "Tamamlanan import kaydının listesi")
def test_view_completed_import_detail():
    """Tamamlanan import kaydının listesi görüntülenmeli."""
