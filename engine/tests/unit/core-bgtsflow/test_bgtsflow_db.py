...
def mock_db(monkeypatch, tmp_path):
    """Her test için geçici bir veritabanı oluşturur."""
    test_db_path = tmp_path / "test_database.sqlite"
    # core.db modülü artık settings.DB_PATH'i kullanıyor; _db_path fonksiyonunu
    # geçici path döndürecek şekilde override ediyoruz.
