...
BASE_URL=http://localhost:3000 (Neurex) üzerinde çalıştığı için arama
...
Güvenli hale getirmek için iki seçenek:
  1) Feature'ı Neurex'nın kendi arama UI'sine uyarla
  2) BASE_URL'i Google'a özel override et ve steps'i Google için güncelle
"""
import pytest

pytest.skip(
    "Google arama senaryosu Neurex BASE_URL'iyle uyumsuz — skip.",
