...
from routes.connector_routes import connector_bp
from routes.visual_semantic_routes import visual_semantic_bp
...
for bp in [
    ...
    rca_bp, self_heal_bp, connector_bp, visual_semantic_bp, continuous_bp,
    *_optional_bps,
]:
